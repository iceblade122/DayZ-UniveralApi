class UniversalDSEndpoint extends UApiBaseEndpoint
{
	...
	//Sends a DM to a user's discord returns `StatusObject`
	...
	int KickUser(string GUID, string Reason = "", Class cbInstance = NULL , string cbFunction = "", bool ReturnString = false) 
	{
		...
		UApiTextObject txtObj = new UApiTextObject(Reason);
	...
	int MuteUser(string GUID, bool ToMute, Class cbInstance = NULL, string cbFunction = "", bool ReturnString = false) 
	{
		...
		UApiDiscordMute muteObject = new UApiDiscordMute(ToMute);
	...
	int SetNickname(string GUID, string Nickname, Class cbInstance = NULL, string cbFunction = "", bool ReturnString = false) 
	{
		...
		UApiDiscordNickname nickObject = new UApiDiscordNickname(Nickname);
	...
	int ChannelEdit(string id, string reason, UApiChannelUpdateOptions options, Class cbInstance = NULL, string cbFunction = "", bool ReturnString = false)
	{
		if(id == "" || reason == "")
		{
	...
	int ChannelMessages(string id, Class cbInstance, string cbFunction, UApiDiscordChannelFilter filter = NULL, bool ReturnString = false)
	{
		if(id == "")
		{
